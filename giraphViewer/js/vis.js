...
$(document).ready(function(){
  ...
  // performs BFS from a source
  $("#BFS").click(function(e){
    $('circle').click(function(){
      var startvertex = $(this).parent().attr('title');
      var results = giraph.alg.BFS(graph, startvertex);
      $('circle').off('click');
    });
  });

  // performs DFS from a source
  $("#DFS").click(function(e){
    $('circle').click(function(){
      var startvertex = $(this).parent().attr('title');
      var results = giraph.alg.DFS(graph, startvertex);
      $('circle').off('click');
    });
  });
